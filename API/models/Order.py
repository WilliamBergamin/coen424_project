...
class Order:
    ...
    def find(cls, order_key):
        _id = base64.urlsafe_b64decode(zlib.decompress(order_key.encode("ASCII"))).decode('utf8')
    ...
    def to_dict(self):
        ...
        return {
            'order_key': zlib.compress(base64.urlsafe_b64encode(order_key_str)).decode("ASCII"),
